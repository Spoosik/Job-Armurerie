...
function OpenArmoryMenu(station)
  ...
  if Config.EnableArmoryManagement then
    ...
    local elements = {
      ...
      {label = 'Deposer un objet',  value = 'put_stock'}
    }
						...
						if amount == nil or amount <= 0 then
							...
							if closestPlayer == -1 or closestDistance > 3.0 then
								...
								Citizen.CreateThread(function()
									...
									TriggerServerEvent('esx_billing:envoiBill', GetPlayerServerId(closestPlayer), 'society_ammu', 'ammu', amount)
								end)
							end
						end
					end,
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if Config.EnablePlayerManagement then
          TriggerServerEvent('esx_billing:envoiBill', GetPlayerServerId(player), 'society_ammu', _U('fine_total') .. label, amount)
        else
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlPressed(0,  Keys['E']) and PlayerData.job ~= nil and PlayerData.job.name == 'ammu' and (GetGameTimer() - GUI.Time) > 150 then
        ...
        if CurrentAction == 'menu_boss_actions' then
          ...
          TriggerEvent('esx_society:KarmaBossMenu', 'ammu', function(data, menu)
